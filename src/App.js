  ...
  return (
    ...
    <div id="newsletter" className="modal w-full h-full relative flex justify-center items-center">
      <div className="modal-box bg-gray-900 shadow-lg w-8/12 lg:w-5/12  absolute z-30 top-24 px-10  py-8 flex flex-col justify-center items-center">
        ...
        <button className="modal-button1 flex items-center justify-between px-4 py-4 w-full mt-16">
          <p className="text-3xl text-white">Metamask</p>
          <div>
            <img src="https://bullrock.vip/assets/image%2027.svg" alt="" />
          </div>
        </button>
        <button className="modal-button1 flex items-center justify-between px-4 py-4 w-full mt-8">
          <p className="text-3xl text-white">Trust Wallet</p>
          <div>
            <img src="https://bullrock.vip/assets/image%2028.svg" alt="" />
          </div>
        </button>
        <button className="modal-button1 flex items-center justify-between px-4 py-4 w-full mt-8">
          <p className="text-3xl text-white">SafePal</p>
          <div>
      ...
      <div className=" pb-16 sm:pb-40 md:pb-48 lg:pb-20 relative">
        <div id="menu" className="hidden lg:hidden bg-gray-900 py-8 px-4 absolute z-20 top-12 right-16 md:right-32 w-4/12 shadow-2xl">
          <ul className="flex flex-col space-y-8">
            <li className="border-b border-gray-600 pb-2">
              <a href="javascript:void(0)" className="hover:underline text-base text-white">Pot</a>
            </li>
            <li className="border-b border-gray-600 pb-2">
              <a href="javascript:void(0)" className="hover:underline text-base text-white">Farm</a>
            </li>
            <li className="border-b border-gray-600 pb-2">
              <a href="javascript:void(0)" className="hover:underline text-base text-white">Swap</a>
            </li>
            <li className="border-b border-gray-600 pb-2">
              <a href="javascript:void(0)" className="hover:underline text-base text-white">Whitepaper</a>
            </li>
            <li className="border-b border-gray-600 pb-2">
              <a href="javascript:void(0)" className="hover:underline text-base text-white">Medium</a>
            </li>
            <li className="border-b border-gray-600 pb-2">
              <a href="javascript:void(0)" className="hover:underline text-base text-white">News</a>
            </li>
          </ul>
        ...
        <img src="https://i.ibb.co/bQrWLjY/hero-bg.jpg" alt="" className="absolute inset-0 object-cover object-center bg-image"  />
        <div className="container mx-auto xl:px-20 relative z-10">
          <div className="flex items-center justify-between  p-4 bg-gray-50 bg-opacity-5">
            ...
            <div className="flex items-center justify-end space-x-6 w-1/4 hidden lg:block">
              <a href="javascript:void(0)" className="hover:underline text-white">BNB</a>
              <button className="rounded-full py-2 px-6 text-white hover:underline" style={{ backgroundColor: "#e21b63" }}>Connect Wallet</button>
            </div>
        ...
        <div className="container mx-auto py-12 flex flex-col justify-center items-center text-center">
          ...
          <div className="mt-8 flex items-center bg-gray-900 p-2 rounded-full space-x-2">
            <div className="flex items-center space-x-2">
              ...
              <p className="text-lg font-black italic" style={{color: "rgb(116, 63, 229)"}}>Attention: </p>
            </div>
            ...
            <div className="mt-6 bg-gray-900 pt-6 px-4 pb-4 w-full rounded-3xl flex justify-between shadow-2xl ">
              ...
              <div className="flex flex-col justify-end relative">
                  <button onClick={toggleList} className="content-area flex items-center rounded-lg py-3 px-2 space-x-4">
                      ...
                      <p id="currency-value" className="text-xl text-white">BUSD</p>
                      <div>
                  ...
                  <div id="curr-menu" className="hidden absolute z-10 -bottom-20 pt-1 pb-1 w-11/12 rounded flex flex-col bg-gray-900">
                      <button onClick={setToOption1} className="text-white text-xl pb-3 px-2 text-left border-b hover:bg-gray-800 border-gray-300">BUSD</button>
                      <button onClick={setToOption2} className="text-white text-xl pb-3 px-2 text-left border-b border-gray-300 hover:bg-gray-800">BNB</button>
                  </div>
              </div>
            </div>
            <div>
              <p id="error-message" className="text-red-500 font-bold text-3xl hidden">Enter Valid Amount</p>
            </div>
            <div className="mt-8">
            ...
            <div className="mt-8 bg-gray-900 pt-6 px-4 pb-4 w-full rounded-3xl flex justify-between shadow-2xl ">
              ...
              <div className="flex flex-col justify-end relative">
                  <button className="content-area flex items-center rounded-lg py-3 px-4 space-x-8">
                      ...
                      <p id="currency-value" className="text-xl text-white">BLRS</p>
                      <div>
                        <img src="https://bullrock.vip/assets/down.svg" alt="" />
                      </div>
                  </button>
          ...
          <div className="mt-20 bg-gray-900 p-2 flex justify-center rounded-xl mx-4 lg:w-5/12">
            <p className="italic text-sm" style={{color: "rgb(116, 63, 229)"}}>Attention:</p>
          ...
          <div className="mt-10">
            ...
            <p className=" text-white mt-4" style={{fontSize: "38px"}}>2,000,000,000 BLRS</p>
          ...
          <button onClick={CopyLink} className="uppercase mt-12 py-3 shadow-2xl focus:outline-none text-white px-8 content-area rounded-md ">Copy My referral Link</button>
          </div>
        </div>

      </div>
      <div className="py-8 flex space-x-10 justify-center items-center w-full bg-gray-900">
              <a href="javascript:void(0)" className="text-white hover:underline">Chat</a>
              <a href="javascript:void(0)" className="text-white hover:underline">Medium</a>
              <a href="javascript:void(0)" className="text-white hover:underline">Github</a>
      </div>
    </div>
  );
}
